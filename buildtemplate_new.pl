...
print "curl -XGET -k -u $user:$password -H 'Content-Type:application/json' https://$httpHost:9243/.ds-$index-$today*/_mapping?pretty";

@curl =`curl -XGET -k -u $user:$password -H "Content-Type:application/json" "https://$httpHost:9243/.ds-$index-$today*/_mapping?pretty"`;
print @curl;
